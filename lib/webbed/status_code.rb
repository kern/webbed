...
module Webbed
  ...
  class StatusCode
    ...
    REQUEST_TIMEOUT                 = register(new(408, "Request Timeout"))
    ...
    REQUEST_ENTITY_TOO_LARGE        = register(new(413, "Request Entity Too Large"))
    REQUEST_URI_TOO_LONG            = register(new(414, "Request-URI Too Long"))
    ...
    GATEWAY_TIMEOUT                 = register(new(504, "Gateway Timeout"))
